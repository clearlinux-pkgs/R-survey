...
Source0  : https://cran.r-project.org/src/contrib/survey_4.4-2.tar.gz
Summary  : Analysis of Complex Survey Samples
Group    : Development/Tools
License  : GPL-2.0 GPL-3.0
Requires: R-survey-lib = %{version}-%{release}
Requires: R-Rcpp
...
%package lib
Summary: lib components for the R-survey package.
Group: Libraries

%description lib
lib components for the R-survey package.


%prep
%setup -q -n survey
pushd ..
cp -a survey buildavx2
popd
pushd ..
cp -a survey buildavx512
popd
pushd ..
cp -a survey buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711036764
...
/usr/lib64/R/library/survey/doc/survey-sae.html
/usr/lib64/R/library/survey/doc/survey-sae.html.asis
...
/usr/lib64/R/library/survey/tests/brewer_cpp.R
...
/usr/lib64/R/library/survey/tests/confintrep.R
...
/usr/lib64/R/library/survey/tests/degf-svrepdesign.R
...
/usr/lib64/R/library/survey/tests/multistage-rcpp.R
...
/usr/lib64/R/library/survey/tests/qrule-swiss.R
...
/usr/lib64/R/library/survey/tests/testSUMMER/SUMMER.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/survey/libs/survey.so
/V4/usr/lib64/R/library/survey/libs/survey.so
/VA/usr/lib64/R/library/survey/libs/survey.so
/usr/lib64/R/library/survey/libs/survey.so
