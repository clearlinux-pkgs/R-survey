...
Version  : 3.36
Release  : 23
URL      : https://cran.r-project.org/src/contrib/survey_3.36.tar.gz
Source0  : https://cran.r-project.org/src/contrib/survey_3.36.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1556405539
